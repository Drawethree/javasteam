...
* [Latest Release](https://github.com/l7ssha/javasteam/releases/tag/1.5.0-PRE)
...
dependencies {
    // Main API library
    compile 'com.github.l7ssha:javasteam:1.5.0-PRE'
}
```
...
libraryDependencies += "com.github.l7ssha" % "javasteam" % "1.5.0-PRE"
```
